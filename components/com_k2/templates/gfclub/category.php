...
//print_r($this->pagination->getPagesCounter());
$pages_arr = explode(' ',$this->pagination->getPagesCounter());
//print_r($pages_arr);
if(count($pages_arr) > 1 && $pages_arr[1] != '1'){
	$pages_str = '. '.$pages_arr[0].' '.$pages_arr[1];
}	else	{
	$pages_str = '';
}
$page_title = $this->escape($this->params->get('page_title')).$pages_str;
if($pages_str != ''){
