...
$lang = array_merge($lang, array(
	...
	'ADD_FOE'					=> 'Добавить в недоброжелатели',
	...
	'EMAIL_BODY_EXPLAIN'		=> 'Сообщение будет отправлено в виде простого текста, не включайте в него HTML или BBCode. В качестве обратного адреса будет показываться Ваш e-mail адрес.',
	'EMAIL_DISABLED'			=> 'Извините, но все функции, связанные с отправкой e-mail, были отключены.',
	'EMAIL_SENT'				=> 'Сообщение было отправлено.',
	'EMAIL_TOPIC_EXPLAIN'		=> 'Сообщение будет отправлено в виде простого текста, не включайте в него HTML или BBCode. Обратите внимание, что информация о теме уже включена в сообщение. В качестве обратного адреса будет показываться Ваш e-mail адрес.',
	'EMPTY_ADDRESS_EMAIL'		=> 'Вы должны указать правильный e-mail адрес получателя.',
	...
	'FLOOD_EMAIL_LIMIT'			=> 'Вы не можете отправить еще один e-mail сразу после предыдущего. Пожалуйста, попробуйте чуть позже.',
	...
	'IM_ICQ'					=> 'Учтите, что пользователь мог отключить прием мгновенных сообщений от неизвестных контактов.',
	'IM_JABBER'					=> 'Учтите, что пользователь мог отключить прием мгновенных сообщений от неизвестных контактов.',
	...
	'REMOVE_FOE'				=> 'Убрать из недоброжелателей',
