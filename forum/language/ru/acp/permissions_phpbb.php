...
$lang = array_merge($lang, array(
	...
	'post_actions'		=> 'Операции с сообщениями',
	'posting'			=> 'Сообщения',
	'profile'			=> 'Профиль',
	'settings'			=> 'Установки',
	'topic_actions'		=> 'Операции с темами',
...
// User Permissions
$lang = array_merge($lang, array(
	'acl_u_viewprofile'		=> array('lang'		=> 'Может просматривать профили, списки пользователей и кто сейчас на форуме', 'cat'		=> 'profile'),
	'acl_u_chgname'			=> array('lang'			=> 'Может менять имя', 'cat'			=> 'profile'),
	'acl_u_chgpasswd'		=> array('lang'		=> 'Может менять пароль', 'cat'		=> 'profile'),
	'acl_u_chgemail'		=> array('lang'		=> 'Может менять e-mail адрес', 'cat'		=> 'profile'),
	'acl_u_chgavatar'		=> array('lang'		=> 'Может менять аватар', 'cat'		=> 'profile'),
	...
	'acl_u_masspm'			=> array('lang'			=> 'Может рассылать сообщения нескольким пользователям', 'cat'			=> 'pm'),
	'acl_u_masspm_group'=> array('lang'		=> 'Может рассылать сообщения группам', 'cat'		=> 'pm'),
	...
	'acl_u_pm_emailpm'		=> array('lang'		=> 'Может отправлять ЛС по e-mail', 'cat'		=> 'pm'),
	...
	'acl_u_pm_img'		=> array('lang' => 'Может использовать BBCode [img] в ЛС', 'cat' => 'pm'),
	'acl_u_pm_flash'	=> array('lang' => 'Может использовать BBCode [flash] в ЛС', 'cat' => 'pm'),

	'acl_u_sendemail'		=> array('lang'		=> 'Может посылать e-mail сообщения', 'cat'		=> 'misc'),
...
$lang = array_merge($lang, array(
	...
	'acl_f_poll'			=> array('lang'			=> 'Может создавать голосования', 'cat'			=> 'polls'),
	'acl_f_vote'			=> array('lang'			=> 'Может голосовать в голосованиях', 'cat'			=> 'polls'),
	...
	'acl_f_img'				=> array('lang' => 'Может использовать BBCode [img]', 'cat' => 'content'),
	'acl_f_flash'			=> array('lang' => 'Может использовать BBCode [flash]', 'cat' => 'content'),
	...
	'acl_f_email'			=> array('lang'			=> 'Может сообщать (другу) по e-mail о теме', 'cat'			=> 'actions'),
...
// Admin Permissions
$lang = array_merge($lang, array(
	'acl_a_board'			=> array('lang'			=> 'Может изменять установки форума/проверять обновления', 'cat'			=> 'settings'),
	...
	'acl_a_email'			=> array('lang'			=> 'Может осуществлять массовую рассылку e-mail', 'cat'			=> 'misc'),
