...
$lang = array_merge($lang, array(
	...
	'BBCODE_EDITED'					=> 'BBCode успешно изменен.',
	...
	'BBCODE_HELPLINE_TOO_LONG'		=> 'Подсказка, которую Вы ввели, слишком длинная.',
	...
	'BBCODE_TAG'					=> 'Тег',
	'BBCODE_TAG_TOO_LONG'			=> 'Указанное имя тега слишком длинное.',
	'BBCODE_TAG_DEF_TOO_LONG'		=> 'Указанное определение тега слишком длинное. Введите более короткое определение.',
	...
	'TOKEN'						=> 'Лексема',
	'TOKENS'					=> 'Лексемы',
	'TOKENS_EXPLAIN'			=> 'Лексемы являются метками-заполнителями для вводимого пользователем содержимого. Правильность указанного содержимого будет подтверждена лишь в случае, если оно отвечает соответствующему определению. Если необходимо, Вы можете нумеровать их путем добавления номера в конце лексемы внутри фигурных скобок, непример {TEXT1}, {TEXT2}.<br /><br />В качестве меток-заполнителей Вы также можете использовать любую из языковых переменных, присутствующих в вашей языковой папке (language/), например: {L_<em>&lt;STRINGNAME&gt;</em>}, где <em>&lt;STRINGNAME&gt;</em> — это имя переведенной строки, которую Вы хотите добавить. Например, {L_WROTE} будет отображено как «wrote» или его перевод в соответствии с языком пользователя.<br /><br /><strong>Учтите, что только лексемы, перечисленные ниже, могут быть использованы в пользовательских BBCodes.</strong>',
	...
	'SIMPLETEXT'		=> 'Буквы латинского алфавита (A-Z), цифры, пробелы, запятые, точки, минус, плюс, дефис и подчеркивание',
	'IDENTIFIER'		=> 'Буквы латинского алфавита (A-Z), цифры, дефис и подчеркивание',
	'NUMBER'			=> 'Любая последовательность цифр',
	'EMAIL'				=> 'Правильный адрес электронной почты',
	'URL'				=> 'Правильный адрес URL с использованием любого протокола (http, ftp и т.п. не могут использоваться для деструктивных операций JavaScript). Если ничего не задано, то к строке будет автоматически добавлен префикс &quot;http://&quot;.',
...
$lang = array_merge($lang, array(
	...
	'CURRENT_ICONS_EXPLAIN'			=> 'Выберите операциЮ, которую нужно применить к уже установленным значкам.',
	'CURRENT_SMILIES'				=> 'Установленные смайлики',
	'CURRENT_SMILIES_EXPLAIN'		=> 'Выберите операцию, которую нужно применить к уже установленным смайликам.',
	...
	'ICONS_DELETED'				=> 'Значок успешно удален.',
	'ICONS_EDIT'				=> 'Изменить значок',
	'ICONS_ONE_EDITED'			=> 'Указанный значок успешно обновлен.',
	...
	'SMILIES_DELETED'				=> 'Смайлик успешно удален.',
	'SMILIES_EDIT'					=> 'Изменить смайлик',
	'SMILIES_NONE_EDITED'			=> 'Смайлики не были обновлены.',
	'SMILIES_ONE_EDITED'			=> 'Указанный смайлик успешно обновлен.',
	...
	'TOO_MANY_SMILIES'				=> 'Достигнут лимит %d смайликов.',
...
// Word censors
$lang = array_merge($lang, array(
    'ACP_WORDS_EXPLAIN'        => 'С помощью этой панели Вы можете добавлять, удалять и изменять слова, которые будут автоматически подвергаться цензуре на ваших форумах. Разрешается регистрация пользователей с никами, содержащими эти слова. В словах могут содержаться подстановочные знаки (*). Например, *тест* будет соответствовать слову «протестировать», тест* — «тестирование», *тест — «протест».',
...
$lang = array_merge($lang, array(
	...
	'NO_UPDATE_RANKS'			=> 'Звание успешно удалено. Однако, аккаунты пользователей, которым оно было присвоено, не были обновлены. Вам необходимо вручную восстановить звания в этих аккаунтов.',

	'RANK_ADDED'				=> 'Звание успешно добавлено.',
	'RANK_IMAGE'				=> 'Картинка к званию',
	'RANK_IMAGE_EXPLAIN'		=> 'Здесь можно присвоить небольшой рисунок, связанный с данным званием. Путь к рисунку задается относительно корневой папки phpBB.',
...
// Disallow Usernames
$lang = array_merge($lang, array(
	'ACP_DISALLOW_EXPLAIN'		=> 'Здесь Вы можете управлять именами пользователей, запрещенными для использования. Запрещенные имена могут содержать подстановочные знаки (*). Примечание: Вы не можете запретить зарегистрированное имя. Сначала вам придется удалить пользователя, а уже потом запретить освободившееся имя.',
	'ADD_DISALLOW_EXPLAIN'		=> 'Здесь Вы можете запретить имя пользователя. Используйте звездочку (*) в качестве подстановочного знака для любых символов.',
	'ADD_DISALLOW_TITLE'		=> 'Добавить запрещенное имя',

	'DELETE_DISALLOW_EXPLAIN'		=> 'Вы можете удалить имя из списка запрещенных, выбрав его и нажав кнопку «Отправить».',
	'DELETE_DISALLOW_TITLE'			=> 'Удалить имя из списка запрещенных',
	'DISALLOWED_ALREADY'			=> 'Указанное имя не может быть запрещено. Оно может уже содержаться в списке запрещенных имен, или в списке автоцензора, или существует пользователь с таким именем.',
	'DISALLOWED_DELETED'			=> 'Запрещенное имя успешно удалено.',
	'DISALLOW_SUCCESSFUL'			=> 'Запрещенное имя успешно добавлено.',
...
// Reasons
$lang = array_merge($lang, array(
	'ACP_REASONS_EXPLAIN'		=> 'Здесь Вы можете управлять причинами, используемыми в жалобах и уведомлениях об отклонении сообщений пользователей. Причина, помеченная звездочкой, не может быть удалена. Обычно эта причина используется в случае, если другие имеющиеся причины не подходят под жалобу пользователя.',
	...
	'IS_TRANSLATED_EXPLAIN'			=> 'Причина локализована. Если указанный заголовок указан в языковых файлах в разделе причин и жалоб, то будет использоваться локализованная форма заголовка и описания причины.',
	...
	'REASON_EDIT_EXPLAIN'			=> 'Здесь Вы можете добавить или изменить причину. Если причина переведена, то используется локализованная версия, вместо указанного здесь описания.',
