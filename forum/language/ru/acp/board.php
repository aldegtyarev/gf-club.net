...
$lang = array_merge($lang, array(
	...
	'ALLOW_QUICK_REPLY_EXPLAIN'		=> 'Данная настройка позволяет включать/выключать функцию быстрого ответа. При включении данной функции необходимо также активировать быстрый ответ в нужных форумах.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_OVERALL_TOPIC_EXPLAIN'	=> 'Включает канал “Все темы”',
	...
	'ACP_FEED_FORUM_EXPLAIN'			=> 'Новые сообщения из отдельных форумов.',
	'ACP_FEED_TOPIC'					=> 'Включить каналы тем',
	'ACP_FEED_TOPIC_EXPLAIN'			=> 'Новые сообщения из отдельных тем.',
	'ACP_FEED_NEWS'						=> 'Каналы новостей',
	'ACP_FEED_NEWS_EXPLAIN'				=> 'Выберите форумы, из которых будет отображаться первое сообщение. Не выбирайте форумов, чтобы отключить канал новостей.<br />Выберите несколько форумов, удерживая клавишу <samp>CTRL</samp> и кликая мышью.',

	'ACP_FEED_GENERAL'					=> 'Общие параметры каналов новостей',

	'ACP_FEED_ITEM_STATISTICS'			=> 'Статистика по элементам',
	'ACP_FEED_ITEM_STATISTICS_EXPLAIN'	=> 'Отображение индивидуальной статистики под элементами канала<br />(Автор, дата и время, количество просмотров и ответов)',
