...
$lang = array_merge($lang, array(
	...
	'ENABLE_QUICK_REPLY_EXPLAIN'		=> 'При включении этой опции для данного форума будет отображаться форма быстрого ответа. Если в Настройках форума глобальная опция быстрого ответа отключена, или если в форуме отключена публикация сообщений, то форма быстрого ответа не будет отображена, даже если здесь она будет включена.',
