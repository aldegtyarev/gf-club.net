...
$lang = array_merge($lang, array(
	...
	'BOTS_EXPLAIN'			=> '«Боты», «пауки» или «ползуны»  — это автоматические агенты, обычно используемые поисковыми системам для обновления своих баз данных. Поскольку они редко должным образом работают с сессиями, они могут исказить счетчики посещений, увеличить нагрузку на сервер и иногда неправильно проиндексировать сайт. Здесь вы можете создать пользователей особого типа в целях преодоления подобных проблем.',
	...
	'BOT_EDIT_EXPLAIN'		=> 'С помощью этой страницы вы можете добавить нового или изменить настройки имеющегося бота. Вы можете указать строку агента бота и ввести один или несколько IP-адресов (или диапазон адресов) для его идентификации. Будьте внимательным при указании строки агента или адресов. Также здесь можно указать стиль и язык форума, которые будет использовать бот. Это поможет снизить использование трафика путем установки облегченного стиля для ботов. Не забудьте настроить подходящие права доступа для специальной группы «Боты».',
	...
	'BOT_NAME_TAKEN'		=> 'Указанное имя уже используется на форуме и не может быть использовано этим ботом.',
	'BOT_NEVER'				=> 'Никогда',
	...
	'ERR_BOT_AGENT_MATCHES_UA'		=> 'Указанный Вами агент бота уже используется.',
	'ERR_BOT_NO_IP'					=> 'Указанные Вами IP-адреса недопустимы или не удается разрешить имя хоста.',
