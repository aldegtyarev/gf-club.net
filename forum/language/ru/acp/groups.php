...
$lang = array_merge($lang, array(
	'ACP_GROUPS_MANAGE_EXPLAIN'			=> 'C помощью этой панели Вы можете управлять всеми группами пользователей. Вы можете удалять их, создавать новые и редактировать существующие. Кроме того, Вы можете назначать администраторов, изменять открытый/скрытый/закрытый статус групп, а также задавать названия и описания групп.',
